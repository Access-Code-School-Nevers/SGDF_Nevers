 ...
 */
final class Version20191108124714 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, objet_id INT NOT NULL, emplacement_id INT NOT NULL, INDEX IDX_23A0E66F520CF5A (objet_id), INDEX IDX_23A0E66C4598A51 (emplacement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE etat (article_id INT NOT NULL, etat TinyInt(1) NOT NULL, commentaire LONGTEXT DEFAULT NULL, PRIMARY KEY(article_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE objet (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, pcb SMALLINT NOT NULL, photo VARCHAR(50) DEFAULT NULL, perissable TinyInt(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE peremption (article_id INT NOT NULL, date_peremption DATE NOT NULL, archive TinyInt(1) NOT NULL, PRIMARY KEY(article_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE etat ADD CONSTRAINT FK_55CAF7627294869C FOREIGN KEY (article_id) REFERENCES article (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE etat DROP FOREIGN KEY FK_55CAF7627294869C');
